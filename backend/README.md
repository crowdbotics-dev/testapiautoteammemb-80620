...
## Project Structure
    ...
    ├── testapiautoteammemb_80620  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_80620`
...
2. Clone this repo and `cd testapiautoteammemb_80620`
